Algoritmo condicionalesejercicio1_correción
	...
	Si OP = 1 Entonces Escribir "Su sueldo en bruto es de 32335. Presione enter para saber más."
		Bruto1= 32335
		Jub1 = Bruto1 - 0.11
		OS1 = Bruto1 - 0.03
		Bono = Bruto1 + 0.08
	...
	Sino 
		Si OP = 2 Escribir "Su sueldo en bruto es de 38630,89. Presione enter para saber más."
		Bruto2= 38630.89
	...
	Sino 
		Si OP = 3 Escribir "Su sueldo en bruto es de 45560,20. Presione enter para saber más."
		Bruto3= 45560.20
	...
	Sino 
		Imprimir "Error. Seleccione un número del 1 al 3 de acuerdo a su puesto de trabajo"
FinSi
FinSi 
FinSi
FinAlgoritmo
